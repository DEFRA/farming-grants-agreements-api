...
describe('acceptOffer', () => {
  ...
  test('should successfully accept an agreement', async () => {
    ...
    agreementsGroupModel.updateOneAgreement.mockResolvedValue(mockUpdateResult)
    ...
    expect(agreementsGroupModel.updateOneAgreement).toHaveBeenCalledWith(
  ...
  test('should throw Boom.notFound when agreement is not found', async () => {
    ...
    agreementsGroupModel.updateOneAgreement.mockResolvedValue(null)
  ...
  test('should handle database errors and log them', async () => {
    ...
    agreementsGroupModel.updateOneAgreement.mockRejectedValue(dbError)
  ...
  test('should rethrow Boom errors without wrapping', async () => {
    ...
    agreementsGroupModel.updateOneAgreement.mockRejectedValue(boomError)
