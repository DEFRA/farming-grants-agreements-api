...
const sqsClient = new SQSClient({
  region: 'eu-west-2', // Use the same region as your LocalStack setup
  // endpoint: 'http://grants-payment-service-localstack-1:4566',
  endpoint: 'http://localhost:4566',
  credentials: {
    accessKeyId: 'test', // LocalStack accepts any non-empty value
    secretAccessKey: 'test'
  }
})

// export const sendGranPaymentMessage = {
